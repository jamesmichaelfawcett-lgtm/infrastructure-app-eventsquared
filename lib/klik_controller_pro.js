...
ProController = function(div, websocket_send_function) {
...
ProController.prototype.set_effect      = function(value) { this.send({'effect'        : +value }); }
ProController.prototype.set_speed       = function(value) { this.send({'speed'         : +value }); }
ProController.prototype.set_trigger     = function(value) { this.send({'trigger'       : +value }); }
ProController.prototype.set_group       = function(value) { this.send({'group'         : +value }); }
ProController.prototype.set_probability = function(value) { this.send({'probability'   : +value }); }
ProController.prototype.set_iterate     = function(value) { this.send({'iterate'       : +value }); }
ProController.prototype.set_iterations  = function(value) { this.send({'iterations'    : +value }); }
ProController.prototype.set_test        = function(value) { this.send({'command'       :  value }); }


var last_rgb = [0,0,0];

ProController.prototype.set_rgb = function(value) { 
    this.send({'rgb':value}); 
    last_rgb = value;
}

ProController.prototype.set_localname  = function(value) { 
    this.send({'localname':value}); 
    this.send({'rgb':last_rgb});
}

const klik_controller_pro_tests = {
...
const klik_controller_pro_colors = {
    'red'           : ['set_rgb', [255,0,0] ],
...
const klik_controller_pro_effects = {
...
const klik_controller_pro_iterations = {
...
const klik_controller_pro_groups = {
    'all (0)'       : ['set_group', 0 ],
    'group 1'       : ['set_group', 1 ],
    'group 2'       : ['set_group', 2 ],
    'group 3'       : ['set_group', 3 ],
...
const klik_controller_pro_speeds = {
...
const klik_controller_pro_probabilities = {
...
const klik_controller_pro_triggers = {
